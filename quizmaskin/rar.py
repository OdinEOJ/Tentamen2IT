...
questions = [
    ...
    },
    {
        ...
        "kategori": "Vær",
        "svar": "Frosne regndråper i Canada",
        "vanskelighetsgrad": "Vanskelig"
    },
    {
        "spørsmål": "Hvilket dyr kan overleve i verdensrommet?",
        "kategori": "Dyr",
        "svar": "Tardigrade (vannbjørn)",
        "vanskelighetsgrad": "Vanskelig"
    },
    {
    ...
    },
    {
        ...
        "svar": "0,0000000000000001 sekunder",
        "vanskelighetsgrad": "Vanskelig"
    },
    {
...
def sendSpørsmålTilFirebase(questions):
    for question in questions:
        doc_ref = db.collection("rar").add(question)
